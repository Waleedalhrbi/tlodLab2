function Header() {
  return (
    <div 
      className="relative bg-cover bg-center h-screen flex items-center justify-start text-white"
      style={{ backgroundImage: 'url(https://img.notionusercontent.com/s3/prod-files-secure%2Ffb56a855-0c74-4a0d-84dc-3fb7c76ae0b3%2F55d7c998-fd67-4237-a21a-c7f9699e229a%2FScreen_Shot_2023-11-26_at_10.49.03_AM_cleanup.png/size/w=1420?exp=1727433093&sig=55VsFI-gS4jjOy3R7xL8-crKIgcAEOnUVzqWnKeLSbQ)' }}
    >
